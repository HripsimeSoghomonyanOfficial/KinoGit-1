...
function send_password(mail) {
    ...
    <div class="reset_password_cont">
        <div class="helper_text">придумайте новый пароль</div>
        <div class="input_box">
            <label class="labels" for="resetNumber">код сброса</label>
        ...
        <div class="input_box">
            <label class="labels" for="confirmPassword">подтвердите пароль</label>
            <div class="input_box_items">
        ...
        <button class="send_password_btn" id="send_password_btn">Сброс пароля</button>
    </div>
    `
